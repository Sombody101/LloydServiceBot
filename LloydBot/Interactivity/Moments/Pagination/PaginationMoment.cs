...
namespace LloydBot.Interactivity.Moments.Pagination;
...
public sealed record PaginationMoment : IdleMoment<IPaginationComponentCreator>
{
    ...
    public override async ValueTask HandleAsync(Procrastinator procrastinator, DiscordInteraction interaction)
    {
        ...
        switch (buttonType)
        {
            ...
            case "stop":
                ...
                CurrentPageIndex = -1;
                await interaction.CreateResponseAsync(DiscordInteractionResponseType.UpdateMessage, new DiscordInteractionResponseBuilder(page.CreateMessage(this)));
                return;
    ...
    public override async ValueTask TimedOutAsync(Procrastinator procrastinator)
    {
        ...
        Page page = Pages[CurrentPageIndex];
        CurrentPageIndex = -1;
        _ = await Message.ModifyAsync(page.CreateMessage(this));
    }
}
